...
Object.defineProperty(exports, "__esModule", { value: true });
exports.sendMessageEventToChild = exports.sendMessageRequestToParent = exports.waitForMessageQueue = exports.processAdditionalValidOrigins = exports.handleParentMessage = exports.processMessage = exports.isAPISupportedByPlatform = exports.ensureInitialized = void 0;
...
function updateRelationships(messageSource, messageOrigin) {
    ...
    if (!globalVars_1.GlobalVars.parentWindow || globalVars_1.GlobalVars.parentWindow.closed || messageSource === globalVars_1.GlobalVars.parentWindow) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.userOriginUrlValidationRegExp = exports.validOriginRegExp = exports.validOrigins = exports.defaultSDKVersionForCompatCheck = exports.version = void 0;
var utils_1 = __webpack_require__(3);
            ...
            function handleGetMediaRequest(response) {
                if (callback) {
                    ...
                    if (mediaResult.error) {
                        ...
                        globalVars_1.GlobalVars.handlers['getMedia' + actionName] = null;
                    }
                    else {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.getConfigSetting = exports.getChatMembers = exports.registerCustomHandler = exports.sendCustomEvent = exports.sendCustomMessage = exports.uploadCustomApp = exports.showNotification = exports.openFilePreview = exports.exitFullscreen = exports.enterFullscreen = exports.getUserJoinedTeams = void 0;
var internalAPIs_1 = __webpack_require__(1);
var globalVars_1 = __webpack_require__(0);
var constants_1 = __webpack_require__(2);
var utils_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.validateViewImagesInput = exports.validateGetMediaInputs = exports.validateSelectMediaInputs = exports.decodeAttachment = exports.createFile = void 0;
var media_1 = __webpack_require__(12);
/**
